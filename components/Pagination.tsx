...
const Pagination = () => {
  ...
  return (
    <div className="join flex justify-center py-16">
      <button
        className="join-item btn btn-lg bg-red-600 text-white hover:bg-white hover:text-red-600"
        onClick={() => decrementPage()}
      >
        «
      </button>
      <button className="join-item btn btn-lg bg-red-600 text-white hover:bg-white hover:text-red-600">
        Page {page}
      </button>
      <button
        className="join-item btn btn-lg bg-red-600 text-white hover:bg-white hover:text-red-600"
